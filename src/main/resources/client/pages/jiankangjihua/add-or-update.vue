...
<view class="content">
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ff993310","height":"auto"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"none","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">计划名称</view>
				<input :style='{"border":"2rpx solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"0px","flex":"1","background":"#ffffff","fontSize":"28rpx","lineHeight":"64rpx","height":"64rpx"}' :disabled="ro.jihuamingcheng" v-model="ruleForm.jihuamingcheng" placeholder="计划名称"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class=" select">
				...
				<picker :style='{"width":"100%","flex":"1","height":"auto"}' mode="date" :value="ruleForm.kaishishijian" @change="kaishishijianChange">
					<view :style='{"border":"2rpx solid #eeeeee","padding":"0 20rpx","color":"#666666","background":"#ffffff","width":"100%","lineHeight":"64rpx","fontSize":"28rpx"}' class="uni-input">{{ruleForm.kaishishijian?ruleForm.kaishishijian:"请选择开始时间"}}</view>
				</picker>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class=" select">
				...
				<picker :style='{"width":"100%","flex":"1","height":"auto"}' mode="date" :value="ruleForm.jieshushijian" @change="jieshushijianChange">
					<view :style='{"border":"2rpx solid #eeeeee","padding":"0 20rpx","color":"#666666","background":"#ffffff","width":"100%","lineHeight":"64rpx","fontSize":"28rpx"}' class="uni-input">{{ruleForm.jieshushijian?ruleForm.jieshushijian:"请选择结束时间"}}</view>
				</picker>
			</view>
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">计划简介</view>
				<textarea :style='{"border":"2rpx solid #eeeeee","padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","color":"#000000","borderRadius":"0px","flex":"1","background":"#ffffff","fontSize":"28rpx","height":"240rpx"}' v-model="ruleForm.jihuajianjie" placeholder="计划简介"></textarea>
			</view>
			...
			<view :style='{"padding":"12rpx 0 12rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","fontWeight":"500"}' class="title">计划内容</view>
                <xia-editor ref="editor" :style='{"minHeight":"320rpx","border":"2rpx solid #eeeeee","padding":"20rpx","color":"#666666","background":"#ffffff","width":"100%","height":"auto"}' v-model="ruleForm.jihuaneirong" placeholder="计划内容" @editorChange="jihuaneirongChange"></xia-editor>
			</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`jiankangjihua`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='jihuajianjie'){
					this.ruleForm.jihuajianjie = obj[o];
					this.ro.jihuajianjie = true;
					continue;
					}
					if(o=='jihuaneirong'){
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`jiankangjihua`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`jiankangjihua`, this.ruleForm);
						}else{
							await this.$api.add(`jiankangjihua`, this.ruleForm);
						}
